...
path2=paste0(path, "analysis/correlacao_4/rq3_issues/data_granger/")

outfile1=paste0(path2, "lag1/granger_cs_issues_", app, "_lag1.csv")
outfile2=paste0(path2, "lag2/granger_cs_issues_", app, "_lag2.csv")
outfile3=paste0(path2, "lag3/granger_cs_issues_", app, "_lag3.csv")
outfile4=paste0(path2, "lag4/granger_cs_issues_", app, "_lag4.csv")
