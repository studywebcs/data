...
outfilelm=paste0(path, "analysis/correlacao_4/rq3_issues/data_issuesn/lm/csn_lm_issuesn_", app, ".csv")
outfilete08=paste0(path, "analysis/correlacao_4/rq3_issues/data_issuesn/te08/te08_csn_issuesn_", app, ".csv")
outfilete08lag2=paste0(path, "analysis/correlacao_4/rq3_issues/data_issuesn/te08lag2/te08lag2_csn_issuesn_", app, ".csv")
outfilete08lag3=paste0(path, "analysis/correlacao_4/rq3_issues/data_issuesn/te08lag3/te08lag3_csn_issuesn_", app, ".csv")
outfilete08lag4=paste0(path, "analysis/correlacao_4/rq3_issues/data_issuesn/te08lag4/te08lag4_csn_issuesn_", app, ".csv")
...
##pp.test(x_issues)
#x_issues
x_issues = x_issues / cs_metrics$SUM *1000
#x_issues

# estudar estacionaridade: teste de raiz unitária de PP (Phillips-Perron)
##pp.test(x_issues)
...
#i=8
  ...
  #} else if (a == "CouplingBetweenObjects"){
    ...
    te_result=transfer_entropy(x=x_series, y=x_issues, lx=1, ly=1, q=0.8, entropy=c('Renyi') ,quiet=TRUE ,  seed=TRUE,shuffles = 500, quantiles = c(10,90))
    ...
    te_result1=transfer_entropy(x_series, x_issues, 2, 2, 0.8, entropy=c('Renyi'), quiet=T, seed=TRUE,shuffles = 500, quantiles = c(10,90))
    ...
    te_result2=transfer_entropy(x_series, x_issues, 3, 3, 0.8, entropy=c('Renyi'), quiet=T , seed=TRUE,shuffles = 500, quantiles = c(10,90))
    ...
    te_result3=transfer_entropy(x_series, x_issues, 4, 4, 0.8, entropy=c('Renyi'), quiet=T , seed=TRUE,shuffles = 500, quantiles = c(10,90))
