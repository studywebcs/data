...
source(paste0(path, "analysis/correlacao_4/code_smells_issues_day_cor_inc.R"))

outfile=paste0(path, "analysis/correlacao_4/rq3_issues/data_corts_absolute/corts_csn_issues_", app, ".csv")
