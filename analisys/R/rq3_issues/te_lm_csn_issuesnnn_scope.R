...
outfilelm=paste0(path, "analysis/correlacao_5/rq3_issues/data_issuesn_scope/lm/csn_lm_issuesn_", app, ".csv")
outfilete08=paste0(path, "analysis/correlacao_5/rq3_issues/data_issuesn_scope/te08/te08_csn_issuesn_", app, ".csv")
outfilete08lag2=paste0(path, "analysis/correlacao_5/rq3_issues/data_issuesn_scope/te08lag2/te08lag2_csn_issuesn_", app, ".csv")
outfilete08lag3=paste0(path, "analysis/correlacao_5/rq3_issues/data_issuesn_scope/te08lag3/te08lag3_csn_issuesn_", app, ".csv")
outfilete08lag4=paste0(path, "analysis/correlacao_5/rq3_issues/data_issuesn_scope/te08lag4/te08lag4_csn_issuesn_", app, ".csv")
