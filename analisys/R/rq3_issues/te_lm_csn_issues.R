...
outfilelm=paste0(path, "analysis/correlacao_4/rq3_issues/data/lm/csn_lm_issues_", app, ".csv")
outfilete08=paste0(path, "analysis/correlacao_4/rq3_issues/data/te08/te08_csn_issues_", app, ".csv")
outfilete08lag2=paste0(path, "analysis/correlacao_4/rq3_issues/data/te08lag2/te08lag2_csn_issues_", app, ".csv")
outfilete08lag3=paste0(path, "analysis/correlacao_4/rq3_issues/data/te08lag3/te08lag3_csn_issues_", app, ".csv")
outfilete08lag4=paste0(path, "analysis/correlacao_4/rq3_issues/data/te08lag4/te08lag4_csn_issues_", app, ".csv")
