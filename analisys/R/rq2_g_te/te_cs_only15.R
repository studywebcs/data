...
outfile=paste0(path, "analysis/correlacao_4/rq2_g_te/data/te_15/te08_csonly_by_klloc15_3.csv")

ttee = function(xa, xb, nlag){
  
  
  
  te_result=transfer_entropy(xa, xb, nlag, nlag, 0.8, entropy=c('Renyi'), quiet=T , seed=TRUE,shuffles = 500, quantiles = c(15,85))
