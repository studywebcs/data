...
outfile=paste0(path, "analysis/correlacao_4/rq2_g_te/data/te_10tudo/te08_csonly_by_klloc10.csv")

ttee = function(xa, xb, nlag){
  
  te_result=transfer_entropy(xa, xb, nlag, nlag, 0.8, entropy=c('Renyi'), quiet=T , seed=TRUE,shuffles = 500, quantiles = c(10,90))
...
doSixCombinations= function(nlag){
  ...
  loga ("client_js,server;", te5, nlag)
