...
outfile=paste0(path, "analysis/correlacao_4/rq2_g_te/data/te08_csonly_nnn_",app,".csv")

ttee = function(xa, xb, nlag){
  
  #transfer_entropy(x_series, x_issues, 2, 2, 0.8, entropy=c('Renyi'), quiet=T, seed=TRUE,shuffles = 500, quantiles = c(20,80))
  te_result=transfer_entropy(xa, xb, nlag, nlag, 0.8, entropy=c('Renyi'), quiet=T , seed=TRUE,shuffles = 500, quantiles = c(20,80))
