...
outfilelm=paste0(path, "analysis/correlacao_5/rq4_bugs/data_scope/lm/csn_lm_bugs_", app, ".csv")
outfilete08=paste0(path, "analysis/correlacao_5/rq4_bugs/data_scope/te08/te08_csn_bugs_", app, ".csv")
outfilete08lag2=paste0(path, "analysis/correlacao_5/rq4_bugs/data_scope/te08lag2/te08lag2_csn_bugs_", app, ".csv")
outfilete08lag3=paste0(path, "analysis/correlacao_5/rq4_bugs/data_scope/te08lag3/te08lag3_csn_bugs_", app, ".csv")
outfilete08lag4=paste0(path, "analysis/correlacao_5/rq4_bugs/data_scope/te08lag4/te08lag4_csn_bugs_", app, ".csv")
