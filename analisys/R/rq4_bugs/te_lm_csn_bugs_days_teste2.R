...
outfilelm=paste0(path, "analysis/correlacao_4/rq4_bugs/data_days_teste2/lm/csn_lm_bugs_dteste2_", app, ".csv")
outfilete08=paste0(path, "analysis/correlacao_4/rq4_bugs/data_days_teste2/te08/te08_csn_bugs_dteste2_", app, ".csv")
outfilete08lag2=paste0(path, "analysis/correlacao_4/rq4_bugs/data_days_teste2/te08lag2/te08lag2_csn_bugs_dteste2_", app, ".csv")
outfilete08lag3=paste0(path, "analysis/correlacao_4/rq4_bugs/data_days_teste2/te08lag3/te08lag3_csn_bugs_dteste2_", app, ".csv")
outfilete08lag4=paste0(path, "analysis/correlacao_4/rq4_bugs/data_days_teste2/te08lag4/te08lag4_csn_bugs_dteste2_", app, ".csv")
...
vage = cs_metrics$VersionAge[-1]
len=length(x_issues)
# 
lenminus1=len - 1
#
dend2=index(x_issues[len])
dend1=index(x_issues[lenminus1])

dif=julian(dend2, dend1)

vage[len]=dif[1]

vage

x_issues = x_issues / vage    # for issuesn only by day
#x_issues = x_issues / (cs_metrics$SUM * vage) * 1000    # for issuesn
