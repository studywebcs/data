...
source(paste0(path, "analysis/correlacao_5/code_smells_bugs_inc.R"))

outfilelm=paste0(path, "analysis/correlacao_5/rq4_bugs/data_bugsn_scope/lm/csn_lm_bugs_", app, ".csv")
outfilete08=paste0(path, "analysis/correlacao_5/rq4_bugs/data_bugsn_scope/te08/te08_csn_bugs_", app, ".csv")
outfilete08lag2=paste0(path, "analysis/correlacao_5/rq4_bugs/data_bugsn_scope/te08lag2/te08lag2_csn_bugs_", app, ".csv")
outfilete08lag3=paste0(path, "analysis/correlacao_5/rq4_bugs/data_bugsn_scope/te08lag3/te08lag3_csn_bugs_", app, ".csv")
outfilete08lag4=paste0(path, "analysis/correlacao_5/rq4_bugs/data_bugsn_scope/te08lag4/te08lag4_csn_bugs_", app, ".csv")
...
x_issues = x_issues / cs_metrics$SUM * 1000    #densidade
...
for (i in 12:14){
  ...
  if (sum(cs[, i]) == 0){
    ...
    te_result=transfer_entropy(x=x_series, y=x_issues, lx=1, ly=1, q=0.8, entropy=c('Renyi') ,quiet=TRUE ,  seed=TRUE,shuffles = 500, quantiles = c(15,85))
    ...
    te_result1=transfer_entropy(x_series, x_issues, 2, 2, 0.8, entropy=c('Renyi'), quiet=T, seed=TRUE,shuffles = 500, quantiles = c(15,85))
    ...
    te_result2=transfer_entropy(x_series, x_issues, 3, 3, 0.8, entropy=c('Renyi'), quiet=T , seed=TRUE,shuffles = 500, quantiles = c(15,85))
    ...
    te_result3=transfer_entropy(x_series, x_issues, 4, 4, 0.8, entropy=c('Renyi'), quiet=T , seed=TRUE,shuffles = 500, quantiles = c(15,85))
