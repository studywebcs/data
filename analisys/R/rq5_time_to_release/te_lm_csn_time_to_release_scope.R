...
outfilelm=paste0(path, "analysis/correlacao_5/rq5_time_to_release/data_scope/lm/csn_lm_ttr_", app, ".csv")
outfilete08=paste0(path, "analysis/correlacao_5/rq5_time_to_release/data_scope/te08/te08_csn_ttr_", app, ".csv")
outfilete08lag2=paste0(path, "analysis/correlacao_5/rq5_time_to_release/data_scope/te08lag2/te08lag2_csn_ttr_", app, ".csv")
outfilete08lag3=paste0(path, "analysis/correlacao_5/rq5_time_to_release/data_scope/te08lag3/te08lag3_csn_ttr_", app, ".csv")
outfilete08lag4=paste0(path, "analysis/correlacao_5/rq5_time_to_release/data_scope/te08lag4/te08lag4_csn_ttr_", app, ".csv")
...
for (i in 12:14){
  ...
  if (sum(cs[, i]) == 0){
    ...
    te_result=transfer_entropy(x=x_series, y=x_versionage, lx=1, ly=1, q=0.8, entropy=c('Renyi') ,quiet=TRUE ,  seed=TRUE,shuffles = 500, quantiles = c(20,80))
    ...
    te_result1=transfer_entropy(x_series, x_versionage, 2, 2, 0.8, entropy=c('Renyi'), quiet=T, seed=TRUE,shuffles = 500, quantiles = c(20,80))
    ...
    te_result2=transfer_entropy(x_series, x_versionage, 3, 3, 0.8, entropy=c('Renyi'), quiet=T , seed=TRUE,shuffles = 500, quantiles = c(20,80))
    ...
    te_result3=transfer_entropy(x_series, x_versionage, 4, 4, 0.8, entropy=c('Renyi'), quiet=T , seed=TRUE,shuffles = 500, quantiles = c(20,80))
